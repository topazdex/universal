...
/// @title Router for Topaz CL (Slipstream concentrated liquidity) Trades
abstract contract V3SwapRouter is RouterImmutables, Permit2Payments, ICLSwapCallback {
    ...
    /// @notice Performs a Topaz CL exact input swap
    ...
    /// @notice Performs a Topaz CL exact output swap
    /// @param recipient The recipient of the output tokens
